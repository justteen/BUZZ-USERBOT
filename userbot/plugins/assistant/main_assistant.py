...
async def start(event):
    ...
    vent = event.chat_id
    starttext = f"Halo, {nama depan}! Senang Bertemu Anda, Saya {bot_id}, Asisten Bot. \n\n[➤  Creator](https://t.me/psycho_syridwan) \n\nAnda Dapat Berbicara/Menghubungi Creator Saya Menggunakan Bot Ini.\n\nDiberdayakan Oleh [𝐁𝐔𝐙𝐙](https://t.me/ossuport)"
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            vent,
            message=f"Hi BOS {bot_id}, ini asisten mu ! \napa yang ingin ku lakukan?",
            buttons=[
        ...
        await tgbot.send_message(
            ...
            link_preview=False,
            buttons=[
                [Button.url("Help Me ❓", "https://t.me/ossuport")],
                [Button.url("Creator", "https://t.me/psycho_syridwan")],
        ]
        )
...
async def starkisnoob(event):
    ...
    if not is_he_added(user_id):
        ...
        await tgbot.send_message(
            user_id, "Cieee! You Have Been Unblacklisted By My Master."
        )
