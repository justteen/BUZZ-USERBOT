...
@borg.on(lightning_cmd(pattern="bodo$"))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
    animation_ttl = range(0, 14)
    await event.edit("bodo")
    animation_chars = [          
              "YOᑌᖇ ᗷᖇᗩIᑎ ➡️ 🧠\n\n🧠         <(^_^ <)🗑",
              "YOᑌᖇ ᗷᖇᗩIᑎ ➡️ 🧠\n\n🧠       <(^_^ <)  🗑",
              "YOᑌᖇ ᗷᖇᗩIᑎ ➡️ 🧠\n\n🧠     <(^_^ <)    🗑",
...
async def _(event):
    ...
    animation_chars = [
            ...
            "⬜⬜⬛⬜⬜\n⬜⬛⬜⬜⬜\n🔴⬜⬜⬜⬜",
            "🔴⬛⬛⬜⬜\n⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜",
	    "⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜\n⬜  [Buzz](https://t.me/psycho_syridwan) ⬜\n⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜⬜"
...
@borg.on(lightning_cmd(pattern=f"loading$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(lightning_cmd(pattern=f"square$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(lightning_cmd(pattern=f"up$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(lightning_cmd(pattern=f"round$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.3
...
@borg.on(lightning_cmd(pattern=f"love$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(lightning_cmd(pattern=f"buzz$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
    ...
    animation_chars = [
            ...
            "😡",
            "😜",
            "‎**HandsomeBoy hadirlah**",
            "😊",
            "😁",
            "😡",
            "😜",
            "[RIDWAN DISINI](https://t.me/psycho_syridwan)",
            "__**Senang bertemu dengan kalian guys....**__"
        ]
    for i in animation_ttl:
            await asyncio.sleep(animation_interval)
            await event.edit(animation_chars[i % 11])
            
@borg.on(lightning_cmd(pattern=f"fnl$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@borg.on(lightning_cmd(pattern=f"monyet$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 2
...
@borg.on(lightning_cmd(pattern=f"perangkat$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 2
...
@borg.on(lightning_cmd(pattern=f"jari$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(lightning_cmd(pattern=f"sos$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 1
...
@borg.on(lightning_cmd(pattern=f"manusia$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    animation_interval = 0.5
    animation_ttl = range(0, 16)
    await event.edit("manusia...")
    animation_chars = [
