...
#Import Gudz
RUN wget https://raw.githubusercontent.com/justteen/BUZZ-USERBOT/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/justteen/BUZZ-USERBOT/master/requirements.txt
#Start Fumkin
